...
UMocapFoleyAudioRecorderComponent* UMocapRecorderBlueprintLibrary::AddFoleyAudioRecorder(AActor* Owner)
{
    if (!IsValid(Owner))
    {
        return nullptr;
    ...
    UMocapFoleyAudioRecorderComponent* Component = NewObject<UMocapFoleyAudioRecorderComponent>(Owner);
    Component->RegisterComponent();
    Owner->AddInstanceComponent(Component);
    return Component;
}

UMocapChaosDestructionRecorderComponent* UMocapRecorderBlueprintLibrary::AddChaosDestructionRecorder(AActor* Owner)
{
    if (!IsValid(Owner))
    {
        return nullptr;
    ...
    UMocapChaosDestructionRecorderComponent* Component = NewObject<UMocapChaosDestructionRecorderComponent>(Owner);
    Component->RegisterComponent();
    Owner->AddInstanceComponent(Component);
    return Component;
}
