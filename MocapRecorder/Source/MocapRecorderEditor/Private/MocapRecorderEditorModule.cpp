...
static FSimpleMulticastDelegate& GetMocapPostEngineInitDelegate()
{
...
void FMocapRecorderEditorModule::StartupModule()
{
    ...
    PostEngineInitHandle = GetMocapPostEngineInitDelegate().AddRaw(
        this,
        &FMocapRecorderEditorModule::OnPostEngineInit);
}
...
void FMocapRecorderEditorModule::ShutdownModule()
{
    ...
    {
        GetMocapPostEngineInitDelegate().Remove(PostEngineInitHandle);
