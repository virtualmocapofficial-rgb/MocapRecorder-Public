...
struct FMocapClassCaptureRule
{
    ...
    /** Export camera components owned by matching actors as animated Blender-readable cameras. */
    UPROPERTY(EditAnywhere)
    bool bExportCameraComponents = false;
...
public:
    ...
    void SetClassRuleExportCameraComponents(int32 Index, bool bIn);
...
private:
    ...
    int32 SuccessfulBakeJobCount = 0;
